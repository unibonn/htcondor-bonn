...
#declare MediaOK=0; // media = 1 creates a subtle haze
#declare SaveRadOK=0; // save radiosity data for pass 1
#declare LoadRadOK=0; // load radiosity data for pass 2
#declare AreaOK=0; // subtle area light
#declare Ref=0; // intensity of reflections, use 0 to turn off it completely
...
#declare cam_location= <My_Clock, 1, -10>;
#declare cam_lookat= <8.7,2.8,0>;
